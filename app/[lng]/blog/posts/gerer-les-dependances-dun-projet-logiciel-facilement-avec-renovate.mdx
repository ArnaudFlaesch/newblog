...
publishedAt: '2024-02-10T16:00'
summary: Comment maintenir les dépendances d'un logiciel de manière sûre et rapide grâce à un outil automatisé.
...
la liste complète est disponible ici : [https://docs.renovatebot.com/modules/manager/](https://docs.renovatebot.com/modules/manager/).
...
Si vous utilisez Github, vous pouvez l'installer facilement en tant qu'application en vous rendant dans [https://github.com/settings/installations](https://github.com/settings/installations).
...
[https://docs.renovatebot.com/getting-started/running/](https://docs.renovatebot.com/getting-started/running/) et ici [https://docs.renovatebot.com/examples/self-hosting/](https://docs.renovatebot.com/examples/self-hosting/).
...
- Site officiel de Renovate : [https://docs.renovatebot.com/](https://docs.renovatebot.com/)
- Documentation sur la configuration : [https://docs.renovatebot.com/configuration-options/](https://docs.renovatebot.com/configuration-options/)
- Gestion sémantique de version : [https://semver.org/lang/fr/](https://semver.org/lang/fr/)
